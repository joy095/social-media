...
class AdminController {
  ...
  async createEmployee(req: AdminRequest, res: Response, next: NextFunction) {
    try {
      // Check permission
  ...
  async getEmployees(req: AdminRequest, res: Response, next: NextFunction) {
    try {
  ...
  // @access  Private (Admin only)
  async updateEmployee(req: AdminRequest, res: Response, next: NextFunction) {
    try {
      if (!req.employee.hasPermission('create_employee')) {
        return res.status(403).json({
          success: false,
  ...
  // @access  Private (Admin/Manager)
  async setRevenuePricing(req: AdminRequest, res: Response, next: NextFunction) {
    try {
  ...
  async getRevenuePricing(req: AdminRequest, res: Response, next: NextFunction) {
    try {
  ...
  // @access  Private (Admin/Manager)
  async approvePost(req: AdminRequest, res: Response, next: NextFunction) {
    try {
  ...
  // @access  Private (Admin/Manager/Accountant)
  async getApprovedPosts(req: AdminRequest, res: Response, next: NextFunction) {
    try {
      if (!req.employee.hasPermission('view_posts')) {
        return res.status(403).json({
          success: false,
  ...
  async processPayment(req: AdminRequest, res: Response, next: NextFunction) {
    try {
  ...
  // @access  Private (Admin/Accountant)
  async updatePaymentStatus(req: AdminRequest, res: Response, next: NextFunction) {
    try {
      if (!req.employee.hasPermission('manage_payments')) {
        return res.status(403).json({
          success: false,
  ...
  // @access  Private (Admin/Manager/Accountant)
  async getPaymentHistory(req: AdminRequest, res: Response, next: NextFunction) {
    try {
      const page = parseInt(req.query.page as string) || 1;
      const limit = parseInt(req.query.limit as string) || 20;
      const skip = (page - 1) * limit;
  ...
  // @access  Private (Admin/Manager)
  async getBotActivityReport(req: AdminRequest, res: Response, next: NextFunction) {
    try {
